...
insert into Accomodations (name, address, category, latitude, longitude, rating, city_id, status) values
...
insert into Bargains (title, image, price, description, expiration_date, outbound_flight, return_flight, accomodation_id, status) values
...
insert into Accomodations_Features (accomodation_id, feature_id) values
	(1, 1),
    (11, 11),
    (21, 21);
